...
-- MarketRoute V2 production policy patch 0.18.3.5
-- Seed-to-density scheduling correction.
-- Scope: deterministic Genesis growth planner + founder read-model alignment only.
-- No Truth/evidence/AI/authority/schema semantics are changed.
...
-- Keep founder observability aligned with the planner's real phase/next-industry choice.
...
VALUES('MARKETROUTE_V2_GROWTH_SEED_TO_DENSITY_0_18_3_5',18,'MRV2-CONSTITUTION-1.0.0',jsonb_build_object(
  'migration','0025_growth_seed_to_density_policy.sql',
  'new_authority_writer',false,
  'policy_only',true,
  'seed_floor_per_industry',50,
  'depth_before_launch_breadth',true,
  'depth_order','PROFILE_ROUTES_CONTACTS',
  'retry_deferred_work_does_not_block_breadth',true
