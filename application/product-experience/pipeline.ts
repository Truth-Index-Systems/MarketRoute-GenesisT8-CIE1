...
export function productPipeline(input:{activation:WorkspaceActivationStatus;campaign:CampaignReadModel|null}):ProductPipelineStage[]{
  ...
  return [
    ...
    {key:"RESEARCH",label:"Research",detail:"Evidence that changes whether a company matters.",status:status(researchDone,discoverDone&&!researchDone),value:researched>0?`${researched} evidenced`:discoverDone?"Researching":"Waiting",href:"/app/companies"},
