import { commercialAccessRepositoryFromEnvironment, type CommercialAccessRecord, type LockedOpportunityTeaserRecord, type PublicPlanRecord } from "../../platform/database/commercial-access-repository";
