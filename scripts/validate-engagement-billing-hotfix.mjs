...
check("legacy full page shows current access and plan chooser",()=>{assert.match(plans,/legacyFull/);assert.match(plans,/showChooser=!showCurrent\|\|legacyFull/);assert.match(plans,/move onto a standard MarketRoute subscription|Choose a MarketRoute plan/i)});
