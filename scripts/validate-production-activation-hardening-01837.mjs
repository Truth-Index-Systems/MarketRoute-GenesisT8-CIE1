...
check("V2 claim requires explicit offering",()=>{assert.match(migration,/marketroute_claim_workspace_activation_v2/);assert.match(migration,/j\.seller_offering_text IS NOT NULL/);assert.match(repository,/marketroute_claim_workspace_activation_v2/);});
