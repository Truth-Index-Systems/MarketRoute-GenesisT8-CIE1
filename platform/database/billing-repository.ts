...
export interface BillingReconciliationDueRecord { organisation_id:string;external_customer_id:string;external_subscription_id:string; }
...
export class BillingRepository {
  ...
  dueReconciliations(at:string,limit=10){return this.rpc.call<BillingReconciliationDueRecord[]>("marketroute_billing_reconciliation_due_v1",{p_at:at,p_limit:limit});}
  markRecoveryAttempt(organisationId:string,at:string){return this.rpc.call<boolean>("marketroute_mark_billing_recovery_attempt_v1",{p_organisation_id:organisationId,p_at:at});}
}
