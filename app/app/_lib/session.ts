...
import { sessionServiceFromEnvironment, type MarketRouteSession, type WorkspaceMembership } from "@/application/session/service";

export const ACCESS_COOKIE="mr_access_token";
export const REFRESH_COOKIE="mr_refresh_token";
export const ORG_COOKIE="mr_org_id";

export interface WorkspaceSession { session:MarketRouteSession; workspace:WorkspaceMembership; }
