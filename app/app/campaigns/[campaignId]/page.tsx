...
import { CampaignDangerZone,EmptyState,humanStatus,Icon,IntelligenceTable,MetricCard,PageHeader,Panel,SectionHeading,StatusBadge } from "@/ui";
...
export default async function CampaignPage({params,searchParams}:{params:Promise<{campaignId:string}>;searchParams:Promise<Record<string,string|string[]|undefined>>}){
  ...
  const model=await applicationReadServiceFromEnvironment().campaign({organisationId:workspace.organisationId,campaignId});
