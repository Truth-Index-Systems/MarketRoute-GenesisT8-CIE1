...
export default async function Opportunities({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}){
  ...
  if(!campaignId)return <div><PageHeader eyebrow="OPPORTUNITIES" title="The companies" accent="worth your attention." description="MarketRoute brings a company here when the research supports a clear reason to pursue it."/><Panel><EmptyState icon="opportunities" title="No strong opportunities yet" body="MarketRoute is still researching your market. Strong opportunities will appear here as they become clear."/></Panel></div>;
